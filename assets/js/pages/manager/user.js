$(function() {
  ...
  $("#create-form input[name=Stationid]").val(localStorage.getItem('Stationid'));
  $("#edit-form input[name=Stationid]").val(localStorage.getItem('Stationid')); 

  // Initiate datatable for users.
  var table = $('#table').DataTable({
    ajax: localStorage.getItem('api') + '/v1/user.php?Stationid=' + localStorage.getItem('Stationid') + '&MdataTable=true&token=' + localStorage.getItem('key'),
    responsive: true,
    dom: 'f<"toolbar">rtip',
    language: {
