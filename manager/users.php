 ...
 * @Last Modified time: 2018-04-18 00:05:44
 */
...
define('pageDescription', 'This page lets you manage all subsciber accounts, includes features to create, edit, assign roles and delete subscriber accounts.');
?>
<!DOCTYPE html>
<html lang="en">
  <head>  
  ...
  <body>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select class="select2" data-placeholder="Choose User Role" name="role" id="role" required="true" style="width: 100%;">
                      <option value="2" selected="true">Subscriber
                      </option>
                    </select>
                  </div>
                </div><!-- col-6 -->
    ...
    <script src="/assets/js/pages/manager/user.js"></script>
